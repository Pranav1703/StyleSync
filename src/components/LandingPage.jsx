      ...
      <div className="main_page">
        <div className="main_left">
          ...
          <div className="style_para">
            StyleSync is a platform where you can virtually see which <br />{" "}
            cloth suits you.The best part of it is that, it wont overlap <br />{" "}
            the garments on your own cloth but it diffuses with your old <br />
            cloth and you automatically wear a new cloth.
          </div>
        </div>
      ...
      <div className="footer" id="contact">
        ...
        <div className="footer_right" id="about">
          ...
          <div className="footer_text">
            Style Sync redefines the fashion experience, seamlessly replacing
            virtual garments with your current attire. <br />
            You can also get your attire by your imagination. You can give it
            the prompt and it generate the garment and fit to you body.
          </div>
